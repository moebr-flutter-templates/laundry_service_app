...
import 'package:laundry_service_app/screens/LSSchedule/LSScheduleScreen.dart';
import 'package:laundry_service_app/screens/ServiceDetail/LSAboutComponent.dart';
import 'package:laundry_service_app/utils/LSColors.dart';
import 'package:laundry_service_app/utils/LSImages.dart';
import 'package:laundry_service_app/utils/LSWidgets.dart';
    ...
    return Scaffold(
      body: DefaultTabController(
        ...
        child: NestedScrollView(
          ...
          body: TabBarView(
            children: [LSAboutComponent(), PurchaseMoreScreen(), PurchaseMoreScreen(), PurchaseMoreScreen()],
          ),
        ),
      ),
